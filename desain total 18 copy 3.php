...
<head>
    ...
    <style>
        ...
        /* BENTUK KOTAK POTRAIT ROUNDED UNTUK PAS FOTO */
        .shape-rounded {
            object-fit: cover;
            width: 100%;
            height: 100%;
        ...
        .video-panel {
            border: 6px double #c5a059; padding: 0.5rem; border-radius: 0.75rem;
        ...
        /* PENGATURAN TEKS: ubah setiap class di bawah ini secara terpisah */
        .text-cover-kicker { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-cover-title { font-family: 'Cormorant Garamond', serif; font-size: 3.75rem; font-weight: 400; }
        .text-cover-recipient { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-cover-name { font-family: 'Montserrat', sans-serif; font-size: 1.125rem; font-weight: 700; }
        .text-cover-button { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-hero-kicker { font-family: 'Montserrat', sans-serif; font-size: 0.75rem; font-weight: 400; }
        .text-hero-title { font-family: 'Cormorant Garamond', serif; font-size: 3.75rem; font-weight: 400; }
        .text-hero-date { font-family: 'Cormorant Garamond', serif; font-size: 1.25rem; font-weight: 400; }
        .text-section-title { font-family: 'Cormorant Garamond', serif; font-size: 2.25rem; font-weight: 700; }
        .text-body { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-person-name { font-family: 'Cormorant Garamond', serif; font-size: 1.875rem; font-weight: 700; }
        .text-person-detail { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-person-family { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 600; }
        .text-person-location { font-family: 'Montserrat', sans-serif; font-size: 0.75rem; font-weight: 400; }
        .text-social-link { font-family: 'Montserrat', sans-serif; font-size: 0.75rem; font-weight: 600; }
        .text-event-detail { font-family: 'Montserrat', sans-serif; font-size: 1rem; font-weight: 400; }
        .text-event-highlight { font-family: 'Montserrat', sans-serif; font-size: 1.25rem; font-weight: 700; }
        .text-event-button { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 600; }
        .text-count-number { font-family: 'Cormorant Garamond', serif; font-size: 2.25rem; font-weight: 700; }
        .text-count-label { font-family: 'Montserrat', sans-serif; font-size: 0.75rem; font-weight: 400; }
        .text-gallery-caption { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-form-label { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-form-control { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-form-button { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 600; }
        .text-wish-name { font-family: 'Montserrat', sans-serif; font-size: 1rem; font-weight: 700; }
        .text-wish-status { font-family: 'Montserrat', sans-serif; font-size: 0.625rem; font-weight: 600; }
        .text-wish-date { font-family: 'Montserrat', sans-serif; font-size: 0.75rem; font-weight: 400; }
        .text-wish-message { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-footer { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-footer-title { font-family: 'Cormorant Garamond', serif; font-size: 1.5rem; font-weight: 400; }
        .text-footer-name { font-family: 'Cormorant Garamond', serif; font-size: 2.25rem; font-weight: 400; }
        .text-modal-title { font-family: 'Cormorant Garamond', serif; font-size: 1.5rem; font-weight: 700; }
        .text-modal-body { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 400; }
        .text-modal-bank { font-family: 'Montserrat', sans-serif; font-size: 1.125rem; font-weight: 700; }
        .text-modal-account { font-family: 'Montserrat', sans-serif; font-size: 1.25rem; font-weight: 400; }
        .text-modal-button { font-family: 'Montserrat', sans-serif; font-size: 0.875rem; font-weight: 600; }
    </style>
</head>
    ...
    <div id="main-content" class="hidden relative">
            ...
            <div class="relative z-10 container mx-auto px-6 text-center max-w-4xl">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-12 mt-10">
                    <div class="flex-1 text-center" data-aos="fade-up">
                        <!-- OUTLINE DIRUBAH MENJADI 2 OUTLINE (BORDER-DOUBLE) -->
        ...
        <section class="py-20 relative overflow-hidden">
            ...
            <div class="container mx-auto px-6">
                ...
                <!-- OUTLINE DIRUBAH MENJADI 2 OUTLINE (BORDER-DOUBLE) MELALUI CSS -->
        ...
        <!-- Buku Tamu & RSVP (DIPINDAHKAN KE ATAS KADO DIGITAL) -->
        ...
        <!-- Kado Digital (SEKARANG ADA DI BAWAH RSVP) -->
