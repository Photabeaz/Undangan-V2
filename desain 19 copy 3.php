    ...
    <div id="main-content" class="hidden relative">
        <section class="relative w-full h-screen overflow-hidden flex items-center justify-center">
            ...
            <div class="relative z-20 text-center text-white flex flex-col items-center" data-aos="fade-up" data-aos-duration="1500">
                ...
                <h2 class="font-serif text-5xl md:text-7xl italic font-semibold mb-4">Rama & Yuli</h2>
        ...
        <h3 class="font-serif text-4xl text-gold font-bold mb-8 relative z-10" data-aos="fade-up">Menuju Hari Bahagia</h3>
            ...
            <div class="container mx-auto px-6 z-10 relative">    
                ...
                <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Pernikahan+Bagus+%26+Yuli&dates=20260926T050000Z/20260926T110000Z&details=Resepsi+Pernikahan+Bagus+dan+Yuli&location=Br+Gambih+Desa+Buahan+Kec+Payangan" target="_blank" class="inline-block bg-gold text-white px-8 py-3 rounded-full text-sm font-sans font-semibold tracking-wide shadow-lg hover:bg-yellow-700 transition" data-aos="fade-up">
    ...
    <div id="gift-modal" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-black/60 backdrop-blur-sm transition-opacity">
        <div class="bg-white w-11/12 max-w-md p-6 rounded-2xl shadow-2xl relative text-center">
            ...
            <div class="bg-gray-100 p-4 rounded-xl mb-4 border border-gray-200">
                ...
                <p class="text-gray-700 font-sans tracking-widest text-xl mb-2" id="rek-mandiri">1234567890123</p>
                <p class="text-sm font-sans text-gray-500 mb-4">a.n. I Kadek Rama</p>
                <button onclick="copyRekening('1234567890123')" class="bg-white border-double border-[4px] border-gold font-sans text-gold hover:bg-gold hover:text-white px-6 py-2 rounded-full text-sm transition shadow-sm w-full font-semibold">
