...
<head>
    ...
    <style>
        ...
        .shape-rounded {
            ...
            width: 100%;
            height: 100%;
            border-radius: 220px; /* UBAH NILAI INI UNTUK MENGATUR TINGKAT KELENGKUNGAN SUDUT */
        }
        .border-rounded-wrapper {
            border-radius: 220px; /* PASTIKAN NILAI INI SAMA DENGAN YANG ADA DI .shape-rounded */
        }
            ...
            <div class="relative z-10 container mx-auto px-6 text-center max-w-4xl">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-12 mt-10">
                    <div class="flex-1 text-center" data-aos="fade-up">
                        ...
                        <div class="border-rounded-wrapper w-85 h-100 mx-auto overflow-hidden border-[5px] border-goldMilk p-1 shadow-[0_10px_25px_rgba(230,194,122,0.4)] mb-6">
