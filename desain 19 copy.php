...
<head>
    ...
    <!-- Contoh: Great Vibes ditambahkan sebagai contoh font baru -->
    <!-- ========================================================== -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Great+Vibes&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,600;1,400&family=Montserrat:wght@300;400;500;600;700&family=Great+Vibes&display=swap" rel="stylesheet">
    ...
    <style>
        /* ==========================================================
           PUSAT PENGATURAN FONT (CONTROL PANEL)
           Ubah nama font di sini, maka seluruh website akan berubah!
           ========================================================== */
        :root {
            /* 1. DEKLARASI FONT UTAMA (Sesuaikan dengan Google Fonts di atas) */
            --font-utama: 'Montserrat', sans-serif;
            --font-aksen: 'Cormorant Garamond', serif;
            --font-tambahan: 'Great Vibes', cursive; /* Contoh font ke-3 */
            --font-tambahan1: 'Great Vibes regular' , static;

            /* 2. PEMETAAN FONT KE SETIAP BAGIAN */
            /* Jika ingin mengubah font judul utama cover, cukup ganti var(--font-aksen) jadi var(--font-tambahan) */
            
            /* --- Cover & Hero Banner --- */
            --f-cover-title: var(--font-aksen);
            --f-cover-kicker: var(--font-tambahan1  );
            --f-cover-name: var(--font-utama);
            --f-cover-btn: var(--font-utama);
            
            --f-hero-title: var(--font-aksen);
            --f-hero-date: var(--font-aksen);

            /* --- Bagian Umum & Body --- */
            --f-section-title: var(--font-aksen);
            --f-body-text: var(--font-utama);
            
            /* --- Profil Pengantin --- */
            --f-person-name: var(--font-aksen);
            --f-person-detail: var(--font-utama);
            
            /* --- Acara & Hitung Mundur --- */
            --f-event-highlight: var(--font-utama);
            --f-event-detail: var(--font-utama);
            --f-count-number: var(--font-aksen);
            --f-count-label: var(--font-utama);
            
            /* --- Form, RSVP & Modal --- */
            --f-form: var(--font-utama);
            
            /* --- Footer --- */
            --f-footer-title: var(--font-aksen);
            --f-footer-name: var(--font-aksen);
        }
        ...
        /* ==========================================================
           PENERAPAN VARIABEL FONT (Tidak perlu diubah lagi)
           ========================================================== */
        /* Tambahan !important memastikan font terganti meskipun ada class tailwind font-serif/sans di HTML */
        
        /* Cover & Hero */
        .text-cover-kicker { font-family: var(--f-cover-kicker) !important; font-size: 0.875rem; font-weight: 400; }
        .text-cover-title { font-family: var(--f-cover-title) !important; font-size: 3.75rem; font-weight: 400; }
        .text-cover-recipient { font-family: var(--f-body-text) !important; font-size: 0.875rem; font-weight: 400; }
        .text-cover-name { font-family: var(--f-cover-name) !important; font-size: 1.125rem; font-weight: 700; }
        .text-cover-button { font-family: var(--f-cover-btn) !important; font-size: 0.875rem; font-weight: 400; }
        
        .text-hero-kicker { font-family: var(--f-cover-kicker) !important; font-size: 0.75rem; font-weight: 400; }
        .text-hero-title { font-family: var(--f-hero-title) !important; font-size: 3.75rem; font-weight: 400; }
        .text-hero-date { font-family: var(--f-hero-date) !important; font-size: 1.25rem; font-weight: 400; }
        
        /* General Sections */
        .text-section-title { font-family: var(--f-section-title) !important; font-size: 2.25rem; font-weight: 700; }
        .text-body { font-family: var(--f-body-text) !important; font-size: 0.875rem; font-weight: 400; }
        
        /* Profil Pengantin */
        .text-person-name { font-family: var(--f-person-name) !important; font-size: 1.875rem; font-weight: 700; }
        .text-person-detail { font-family: var(--f-person-detail) !important; font-size: 0.875rem; font-weight: 400; }
        .text-person-family { font-family: var(--f-person-detail) !important; font-size: 0.875rem; font-weight: 600; }
        .text-person-location { font-family: var(--f-person-detail) !important; font-size: 0.75rem; font-weight: 400; }
        .text-social-link { font-family: var(--f-person-detail) !important; font-size: 0.75rem; font-weight: 600; }
        
        /* Acara & Waktu */
        .text-event-detail { font-family: var(--f-event-detail) !important; font-size: 1rem; font-weight: 400; }
        .text-event-highlight { font-family: var(--f-event-highlight) !important; font-size: 1.25rem; font-weight: 700; }
        .text-event-button { font-family: var(--f-form) !important; font-size: 0.875rem; font-weight: 600; }
        .text-count-number { font-family: var(--f-count-number) !important; font-size: 2.25rem; font-weight: 700; }
        .text-count-label { font-family: var(--f-count-label) !important; font-size: 0.75rem; font-weight: 400; }
        
        /* Galeri, Form, Modal & Footer */
        .text-gallery-caption { font-family: var(--f-body-text) !important; font-size: 0.875rem; font-weight: 400; }
        .text-form-label { font-family: var(--f-form) !important; font-size: 0.875rem; font-weight: 400; }
        .text-form-control { font-family: var(--f-form) !important; font-size: 0.875rem; font-weight: 400; }
        .text-form-button { font-family: var(--f-form) !important; font-size: 0.875rem; font-weight: 600; }
        
        .text-wish-name { font-family: var(--f-form) !important; font-size: 1rem; font-weight: 700; }
        .text-wish-status { font-family: var(--f-form) !important; font-size: 0.625rem; font-weight: 600; }
        .text-wish-date { font-family: var(--f-form) !important; font-size: 0.75rem; font-weight: 400; }
        .text-wish-message { font-family: var(--f-form) !important; font-size: 0.875rem; font-weight: 400; }
        
        .text-footer { font-family: var(--f-body-text) !important; font-size: 0.875rem; font-weight: 400; }
        .text-footer-title { font-family: var(--f-footer-title) !important; font-size: 1.5rem; font-weight: 400; }
        .text-footer-name { font-family: var(--f-footer-name) !important; font-size: 2.25rem; font-weight: 400; }
        
        .text-modal-title { font-family: var(--f-section-title) !important; font-size: 1.5rem; font-weight: 700; }
        .text-modal-body { font-family: var(--f-body-text) !important; font-size: 0.875rem; font-weight: 400; }
        .text-modal-bank { font-family: var(--f-form) !important; font-size: 1.125rem; font-weight: 700; }
        .text-modal-account { font-family: var(--f-form) !important; font-size: 1.25rem; font-weight: 400; }
        .text-modal-button { font-family: var(--f-form) !important; font-size: 0.875rem; font-weight: 600; }
    </style>
</head>
<body class="font-sans text-textDark antialiased locked">

    <!-- SELURUH KODE BODY KE BAWAH TETAP SAMA SEPERTI MILIK ANDA -->
    ...
    <div id="main-content" class="hidden relative">
        ...
        <section class="relative pb-20 pt-10">
            ...
            <div class="relative z-10 container mx-auto px-6 text-center max-w-4xl">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-12 mt-10">
                    ...
                    <div class="text-5xl font-serif text-gold text-section-title" data-aos="zoom-in">&</div>
        ...
        <section class="pt-20 pb-10 relative bg-creamDark">
            <div class="container mx-auto px-4 relative z-10">
                <div class="max-w-3xl mx-auto bg-white rounded-t-[100px] md:rounded-t-[180px] p-8 md:p-14 shadow-lg text-center" data-aos="fade-up">
                    <h3 class="font-serif text-4xl mb-6 text-gold font-bold text-section-title">Resepsi Pernikahan</h3>
                    
                    <p class="text-sm md:text-base text-gray-600 mb-10 leading-relaxed max-w-xl mx-auto text-body">
                    ...
                    <div class="border-double border-[4px] border-gold p-6 mb-8 rounded-sm" data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <p class="font-bold text-xl text-gold mb-1 text-event-highlight">13.00 WITA</p>
                        <p class="text-gray-700 text-event-detail">s/d Selesai</p>
                    </div>

                    <div class="mb-8 text-gray-700 font-medium text-event-detail" data-aos="fade-up">
        ...
        <section class="py-20 relative overflow-hidden">
            ...
            <div class="container mx-auto px-6">
                ...
                <div class="video-panel rounded-lg mt-12 p-6 font-serif text-center" data-aos="fade-up">
                    <h3 class="font-serif font-semibold text-4xl text-gold mb-6 text-section-title">Momen Kami</h3>
