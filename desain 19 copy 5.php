...
<head>
    ...
    <meta property="og:title" content="Undangan Pernikahan Bagus & Ajung Putri" />
    <meta property="og:description" content="Selamat datang di undangan pernikahan Bagus & Ajung Putri. Terima kasih atas doa dan kehadirannya." />
...
<body class="font-sans text-textDark antialiased locked">
    ...
    <audio id="backsound" loop src="foto/bg.mp3"></audio>
    ...
    <div id="cover-gate" class="fixed inset-0 z-50 flex flex-col items-center justify-center bg-cream overflow-hidden">
        ...
        <div class="z-10 text-center text-white px-6">
            ...
            <h1 class="font-serif text-5xl md:text-7xl mb-4 italic">Bagus & Ajung Putri </h1>
            ...
            <div class="glass-panel inline-block px-6 py-2 rounded-lg mb-8 text-gray-800">
                <p class="font-bold text-lg text-black font-sans"><?= $guest_name ?></p>
            </div>
            <br>
    ...
    <div id="main-content" class="hidden relative">
        <section class="relative w-full h-screen overflow-hidden flex items-center justify-center">
            ...
            <div class="relative z-20 text-center text-white flex flex-col items-center" data-aos="fade-up" data-aos-duration="1500">
                <!-- Ubahan Font Hero Sesuai Gambar The Wedding Of -->
                <p class="font-latin text-4xl md:text-5xl mb-2">The Wedding Of</p>
                <h2 class="font-serif text-5xl md:text-7xl italic font-semibold mb-4">Bagus & Ajung Putri</h2>
                <div class="flex items-center justify-center gap-4 mt-2 w-72">
                    <hr class="flex-grow border-t-[1.5px] border-white">
                    <p class="font-serif text-xl md:text-2xl font-bold tracking-[0.1em]">26-09-2026</p>
                    <hr class="flex-grow border-t-[1.5px] border-white">
                </div>
            </div>
        ...
        <section class="relative pb-20 pt-10">
            ...
            <div class="relative z-10 container mx-auto px-6 text-center max-w-4xl">
                <div data-aos="fade-up">
                    <h3 class="mb-6 font-latin text-[3rem] md:text-[3.5rem] text-gold font-normal leading-tight">~ Om Swastyastu ~</h3>
                    <p class="mb-12 max-w-2xl mx-auto font-serif text-lg md:text-xl italic font-medium text-[#4a4a4a] leading-loose">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-12 mt-10">
                    <div class="flex-1 text-center" data-aos="fade-up">
                        ...
                        <h4 class="mb-2 font-serif text-2xl md:text-3xl italic font-semibold text-gold">Ns. I Putu Bagus Pradhana Putra, S.Kep</h4>
                        <p class="mb-2 font-serif text-xl italic font-bold text-gray-800 mt-4">Putra Pertama Dari</p>
                        <p class="mb-4 font-serif text-lg italic font-medium text-gray-700 leading-relaxed">Bapak I Putu Agus Arumbawa <br> & <br> Ibu Ni Luh Ardiati</p>
                        <p class="mb-6 font-serif text-base italic font-medium text-gray-600">Br. Gunung Salak, Desa Gunung Salak, Selemadeg Timur, Tabanan</p>
                        <a href="#" class="transition shadow-sm inline-flex items-center justify-center bg-[#b39b59] hover:bg-btnBrown text-white font-serif text-lg italic font-medium py-2 px-6 rounded">
                            <i class="fa-brands fa-instagram text-lg align-middle mr-2"></i> @bagus_ig
                        </a>
                    </div>

                    <div class="text-5xl font-serif text-gold font-bold" data-aos="zoom-in">&</div>

                    <div class="flex-1 text-center" data-aos="fade-up">
                        <div class="border-rounded-wrapper w-85 h-100 mx-auto overflow-hidden border-double border-[6px] border-goldMilk p-1 shadow-[0_10px_25px_rgba(230,194,122,0.4)] mb-6">
                            <img src="foto/foto (6).jpg" alt="Bride" class="w-full h-full object-cover shape-rounded">
                        </div>
                        <h4 class="mb-2 font-serif text-2xl md:text-3xl italic font-semibold text-gold">Ni Putu Agung Muncani Putri, S.Kep</h4>
                        <p class="mb-2 font-serif text-xl italic font-bold text-gray-800 mt-4">Putri Pertama Dari</p>
                        <p class="mb-4 font-serif text-lg italic font-medium text-gray-700 leading-relaxed">Bapak I Gede Agus Suliman <br> & <br> Ibu Gusti Agung Sriadi</p>
                        <p class="mb-6 font-serif text-base italic font-medium text-gray-600">Br. Anyar, Desa Sembung, Mengwi, Badung</p>
                        <a href="#" class="transition shadow-sm inline-flex items-center justify-center bg-[#b39b59] hover:bg-btnBrown text-white font-serif text-lg italic font-medium py-2 px-6 rounded">
                            <i class="fa-brands fa-instagram text-lg align-middle mr-2"></i> @ajungputri_ig
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="pt-20 pb-10 relative bg-creamDark">
            <div class="container mx-auto px-4 relative z-10">
                <div class="max-w-4xl mx-auto bg-white rounded-t-[100px] md:rounded-t-[180px] p-8 md:p-14 shadow-lg text-center" data-aos="fade-up">
                    <h3 class="mb-8 font-latin text-[3rem] md:text-[3.5rem] text-gold font-normal">Acara Pawiwahan</h3>
                    
                    <p class="mb-10 max-w-xl mx-auto font-serif text-lg md:text-xl italic font-medium text-[#4a4a4a] leading-loose">
                    ...
                    <!-- Wrapper Flexbox untuk mensejajarkan Kotak Tanggal & Waktu seperti di gambar -->
                    <div class="flex flex-col md:flex-row justify-center gap-6 mb-8">
                        <div class="flex-1 border-double border-[4px] border-gold p-6 rounded-sm" data-aos="zoom-in">
                            <i class="fa-regular fa-calendar text-4xl text-gold mb-4"></i>
                            <p class="text-2xl text-gold mb-2 font-serif tracking-wide">Sabtu,</p>
                            <p class="text-gray-800 font-serif text-lg">26 September 2026</p>
                        </div>

                        <div class="flex-1 border-double border-[4px] border-gold p-6 rounded-sm" data-aos="zoom-in" data-aos-delay="100">
                            <i class="fa-regular fa-clock text-4xl text-gold mb-4"></i>
                            <p class="text-2xl text-gold mb-2 font-serif tracking-wide">13.00 WITA</p>
                            <p class="text-gray-800 font-serif text-lg">s/d Selesai</p>
                        </div>
                    </div>

                    <div class="mb-8 text-gray-800 font-serif text-lg md:text-xl" data-aos="fade-up">
                        <i class="fa-solid fa-location-dot text-gold mr-2 text-xl"></i> 
                        Br. Gambih, Desa Buahan, Kec. Payangan
                    </div>

                    <a href="https://maps.app.goo.gl/LcaEHZD8eLyXjcfz8" target="_blank" class="block w-full md:w-3/4 mx-auto bg-btnBrown text-white font-sans font-semibold py-3.5 rounded-sm text-sm hover:bg-yellow-800 transition shadow" data-aos="fade-up">
        ...
        <h3 class="font-serif text-4xl text-gold font-bold mb-8 relative z-10" data-aos="fade-up">Menuju Hari Bahagia</h3>
            <div class="absolute inset-0 bg-gradient-to-t from-white via-black/50 to-transparent z-0"></div>
            <div class="container mx-auto px-6 z-10 relative">    
                <div class="flex justify-center gap-4 md:gap-8 mb-10" data-aos="zoom-in">
                    <!-- Opacity yang lebih transparan dengan backdrop-blur untuk readibility -->
                    <div class="bg-white/60  shadow-md rounded-lg w-20 h-24 md:w-24 md:h-28 flex flex-col items-center justify-center border-t-4 border-gold">
                        <span id="days" class="text-3xl md:text-4xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] font-bold font-serif text-gold">00</span>
                        <span class="text-xs md:text-sm uppercase tracking-wider mt-1 font-sans text-gray-700">Hari</span>
                    </div>
                    <div class="bg-white/60 shadow-md rounded-lg w-20 h-24 md:w-24 md:h-28 flex flex-col items-center justify-center border-t-4 border-gold">
                        <span id="hours" class="text-3xl md:text-4xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] font-bold font-serif text-gold">00</span>
                        <span class="text-xs md:text-sm uppercase tracking-wider mt-1 font-sans text-gray-700">Jam</span>
                    </div>
                    <div class="bg-white/60  shadow-md rounded-lg w-20 h-24 md:w-24 md:h-28 flex flex-col items-center justify-center border-t-4 border-gold">
                        <span id="minutes" class="text-3xl md:text-4xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] font-bold font-serif text-gold">00</span>
                        <span class="text-xs md:text-sm uppercase tracking-wider mt-1 font-sans text-gray-700">Menit</span>
                    </div>
                    <div class="bg-white/60  shadow-md rounded-lg w-20 h-24 md:w-24 md:h-28 flex flex-col items-center justify-center border-t-4 border-gold">
                        <span id="seconds" class="text-3xl md:text-4xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] font-bold font-serif text-gold">00</span>
                        <span class="text-xs md:text-sm uppercase tracking-wider mt-1 font-sans text-gray-700">Detik</span>
                    </div>
                </div>
                <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Pernikahan+Bagus+%26+Ajung+Putri&dates=20260926T050000Z/20260926T110000Z&details=Resepsi+Pernikahan+Bagus+dan+Ajung+Putri&location=Br+Gambih+Desa+Buahan+Kec+Payangan" target="_blank" class="inline-block bg-gold text-white px-8 py-3 rounded-full text-sm font-sans font-semibold tracking-wide shadow-lg hover:bg-yellow-700 transition" data-aos="fade-up">
        ...
        <section class="py-20 relative overflow-hidden">
            ...
            <div class="container mx-auto px-6">
                <div class="text-center mb-12" data-aos="fade-up">
                    <h3 class="font-serif text-4xl text-gold font-bold mb-2">Wedding Gallery</h3>
                    <p class="text-sm font-sans text-gray-500">Momen bahagia yang kami abadikan.</p>
                </div>
                ...
                <div id="lightbox" role="dialog" aria-hidden="true" class="fixed inset-0 hidden bg-black/90 z-[60] flex items-center justify-center">
                    ...
                    <p class="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-white font-sans text-sm z-[70]"><span id="lightbox-counter">1</span> / <span id="lightbox-total">20</span></p>
                </div>
                </div>
            </div>
        </section>
            ...
            <div class="content-relative max-w-2xl mx-auto">
                ...
                <div class="flex justify-center gap-4 mb-8" data-aos="fade-up">
                    <div class="bg-white px-4 py-3 rounded-lg shadow text-center flex-1 border-t-2 border-green-500">
                        <p class="text-2xl font-bold font-serif text-gray-800" id="count-hadir">0</p>
                        <p class="text-xs font-sans text-gray-500">Hadir</p>
                    </div>
                    <div class="bg-white px-4 py-3 rounded-lg shadow text-center flex-1 border-t-2 border-red-500">
                        <p class="text-2xl font-bold font-serif text-gray-800" id="count-tidak-hadir">0</p>
                        <p class="text-xs font-sans text-gray-500">Tidak Hadir</p>
                    </div>
                    <div class="bg-white px-4 py-3 rounded-lg shadow text-center flex-1 border-t-2 border-yellow-500">
                        <p class="text-2xl font-bold font-serif text-gray-800" id="count-ragu">0</p>
                        <p class="text-xs font-sans text-gray-500">Ragu-ragu</p>
                    </div>
                </div>

                <!-- Menambahkan Border Emas (Golden Border) seperti pada Profil -->
                <form id="wishes-form" class="bg-white p-6 rounded-xl shadow-[0_10px_25px_rgba(230,194,122,0.4)] border-double border-[6px] border-goldMilk mb-8" data-aos="fade-up">
                    <div class="mb-4">
                        <label class="block text-sm font-sans mb-1 text-gray-600">Nama Anda</label>
                        <input id="guestName" name="nama" type="text" value="<?= htmlspecialchars($guest_name) ?>" readonly class="w-full font-sans border border-gray-300 p-2 rounded bg-gray-100 text-gray-700 cursor-not-allowed focus:outline-none focus:border-gold">
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-sans mb-1 text-gray-600">Konfirmasi Kehadiran</label>
                        <select id="guestAttendance" name="kehadiran" class="w-full font-sans border border-gray-300 p-2 rounded focus:outline-none focus:border-gold bg-white">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-sans mb-1 text-gray-600">Ucapan</label>
                        <textarea id="guestMessage" name="pesan" rows="3" required class="w-full font-sans border border-gray-300 p-2 rounded focus:outline-none focus:border-gold" placeholder="Tulis doa & ucapan Anda di sini..."></textarea>
                    </div>
                    <button type="submit" class="w-full font-sans font-semibold bg-gold text-white py-2 rounded hover:bg-yellow-600 transition shadow <?= $guest_allowed ? '' : 'opacity-55 cursor-not-allowed' ?>" <?= $guest_allowed ? '' : 'disabled' ?> >
                        Kirim RSVP & Ucapan
                    </button>
                    <?php if (!$guest_allowed): ?>
                        <p class="text-xs font-sans text-red-500 mt-2 text-center"><span class="font-semibold">Anda harus menggunakan link undangan khusus (contoh: ?to=NamaAnda) untuk dapat mengirim ucapan.</span></p>
                    <?php endif; ?>
                </form>
        ...
        <section class="py-16 bg-cream text-center">
            <div class="container mx-auto px-6" data-aos="zoom-in">
                <h3 class="font-serif text-4xl text-gold font-bold mb-4">Wedding Gift</h3>
                <p class="text-sm font-sans text-gray-600 mb-8 max-w-xl mx-auto">Bagi keluarga dan sahabat yang ingin mengirimkan kado, silakan menekan tombol di bawah ini.</p>
                <button onclick="toggleGiftModal()" class="bg-gold text-white font-sans px-8 py-3 rounded-full text-sm font-semibold hover:bg-yellow-700 transition shadow-lg">
        ...
        <section class="py-16 bg-gray-900 text-white text-center relative overflow-hidden bg-cover bg-center" style="background-image: url('foto/foto (10).jpg');">
             ...
             <div class="container mx-auto px-6 relative z-10" data-aos="fade-up">
                 <p class="text-sm md:text-base font-sans leading-relaxed mb-8 max-w-2xl mx-auto">
                 ...
                 <h2 class="font-serif text-4xl italic mb-4">Bagus & Ajung Putri </h2>
                 <div class="flex items-center justify-center gap-2 font-sans text-xs text-gray-400">
    ...
    <div id="gift-modal" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-black/60 backdrop-blur-sm transition-opacity">
        <div class="bg-white w-11/12 max-w-md p-6 rounded-2xl shadow-2xl relative text-center">
            ...
            <p class="text-sm font-sans text-gray-600 mb-6">Silakan transfer ke nomor rekening di bawah ini:</p>
            <div class="bg-gray-100 p-4 rounded-xl mb-4 border border-gray-200">
                <p class="font-bold font-sans text-blue-900 mb-1 text-lg">Bank Mandiri</p>
                <p class="text-gray-700 font-sans tracking-widest text-xl mb-2" id="rek-mandiri">1750003882056</p>
                <p class="text-sm font-sans text-gray-500 mb-4">a.n. Ns. I Putu Bagus Pradhana Putra</p>
                <button onclick="copyRekening('1750003882056')" class="bg-white border-double border-[4px] border-gold font-sans text-gold hover:bg-gold hover:text-white px-6 py-2 rounded-full text-sm transition shadow-sm w-full font-semibold">
                    <i class="fa-regular fa-copy mr-1"></i> Salin Nomor Rekening
                </button>
            </div>
            <p class="text-xs font-sans text-gray-400 mt-4 italic">Terima kasih atas doa & hadiah dari Anda.</p>
        </div>
    </div>

    <div id="toast" class="fixed bottom-5 left-1/2 transform -translate-x-1/2 bg-gray-800 font-sans text-white px-4 py-2 rounded-lg opacity-0 transition-opacity duration-300 pointer-events-none z-50">
        ...
        async function fetchWishes() {
            try {
                ...
                if (data.wishes.length === 0) {
                    listContainer.innerHTML = '<p class="text-center font-sans text-sm text-gray-400 py-4">Belum ada ucapan. Jadilah yang pertama!</p>';
                    return;
                }
                ...
                data.wishes.forEach(wish => {
                    ...
                    item.innerHTML = `
                        <div class="flex justify-between items-start mb-1">
                            <h4 class="font-bold font-sans text-dark">${wish.nama}</h4>
                            <span class="text-[10px] px-2 py-0.5 rounded-full bg-gray-100 font-sans font-semibold ${statusColor}">${wish.kehadiran}</span>
                        </div>
                        <p class="text-xs font-sans text-gray-400 mb-2">${wish.waktu}</p>
                        <p class="text-sm font-sans text-gray-700">"${wish.pesan}"</p>
                    `;
