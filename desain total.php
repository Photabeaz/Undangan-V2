...
try {
    ...
    // 2. Cek dan tambah kolom 'kehadiran' jika database lama belum memilikinya
    ...
    // 3. PROSES AJAX / JSON REQUEST (Simpan Data)
    ...
    // 4. PROSES AMBIL DATA (AJAX GET Request oleh JS)
...
<head>
    ...
    <style>
        ...
        .bg-overlay-cream { background-color: rgba(253, 251, 247, 0.85); }
        ...
        /* Custom Oval Shape - Bisa diedit horizontal / vertikal nya */
        .shape-oval {
            object-fit: cover;
            width: 100%;
            height: 100%;
        ...
        .wave-divider {
            ...
            overflow: hidden; line-height: 0; pointer-events: none; z-index: 15;
...
<body class="font-sans text-textDark antialiased locked">
    ...
    <div id="main-content" class="hidden relative">
            ...
            <div class="relative z-10 container mx-auto px-6 text-center max-w-4xl">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-12 mt-10">
                    <div class="flex-1 text-center" data-aos="fade-right">
                        <!-- Border oval memanjang dengan warna emas susu -->
                        <div class="border-oval-wrapper w-64 h-80 mx-auto overflow-hidden border-4 border-goldMilk p-1 shadow-[0_10px_25px_rgba(230,194,122,0.4)] mb-6">
                        ...
                        <p class="text-xs text-gray-500 italic mb-3"><i class="fa-solid fa-location-dot text-gold mr-1"></i> Br. Selat, Buahan Kaja, Payangan</p>
                        <!-- Tombol IG -->
                        <a href="#" class="inline-block bg-gray-100 text-gray-600 px-4 py-1.5 rounded-full text-xs font-semibold hover:bg-gold hover:text-white transition">
                    ...
                    <div class="flex-1 text-center" data-aos="fade-left">
                        ...
                        <p class="text-xs text-gray-500 italic mb-3"><i class="fa-solid fa-location-dot text-gold mr-1"></i> Br. Dinas Kaja, Denpasar</p>
                        <!-- Tombol IG -->
                        <a href="#" class="inline-block bg-gray-100 text-gray-600 px-4 py-1.5 rounded-full text-xs font-semibold hover:bg-gold hover:text-white transition">
        ...
        <!-- Tanggal Resepsi (Posisi Ditukar ke Atas) -->
        <section class="py-20 relative bg-cream">
            ...
            <div class="container mx-auto px-6 relative z-10">
                <div class="max-w-2xl mx-auto glass-panel p-8 rounded-2xl shadow-xl text-center" data-aos="flip-up">
                    ...
                    <a href="https://maps.app.goo.gl/B9cpzbiL5PhXhvDW9" target="_blank" class="inline-block border-2 border-gold text-gold px-6 py-2 rounded-full text-sm font-semibold hover:bg-gold hover:text-white transition shadow">
        ...
        <!-- Hitung Mundur (Posisi Ditukar ke Bawah) -->
        ...
        <section class="py-20 relative overflow-hidden">
            ...
            <div class="container mx-auto px-6">
                ...
                <div id="lightbox" role="dialog" aria-hidden="true">
                    <button id="lightbox-prev" class="absolute left-6 top-1/2 transform -translate-y-1/2 text-white text-3xl hover:text-gold transition z-50"><i class="fa-solid fa-chevron-left"></i></button>
                    <button class="absolute top-6 right-6 text-white text-2xl lightbox-close hover:text-gold transition">&times;</button>
                    <button id="lightbox-next" class="absolute right-6 top-1/2 transform -translate-y-1/2 text-white text-3xl hover:text-gold transition z-50"><i class="fa-solid fa-chevron-right"></i></button>
        ...
        <section id="guestbook" class="py-16 px-6 bg-creamDark">
            <div class="content-relative max-w-2xl mx-auto">
                <h2 class="font-serif text-4xl text-gold font-bold mb-8 text-center" data-aos="fade-down">RSVP & Ucapan</h2>
                ...
                <div id="wishes-list" class="max-h-80 overflow-y-auto pr-2 space-y-4">
                    <!-- Data Ucapan akan dimuat oleh JavaScript -->
                </div>
            </div>
        </section>
    ...
    <script>
        ...
        const sampleImages = ['foto/ph (1).jpg', 'foto/ph (2).jpg', 'foto/ph (3).jpg', 'foto/ph (4).jpg', 'foto/ph (5).jpg']; // Persingkat contoh untuk sampel, aslinya Anda isi kembali
        const galleryImages = [];
        for (let i = 0; i < sampleImages.length; i++) {
            const src = sampleImages[i];
            const a = document.createElement('a');
            a.href = '#'; a.className = `gallery-link block overflow-hidden rounded-lg shadow-sm break-inside-avoid`;
            a.setAttribute('data-aos', 'zoom-in'); a.setAttribute('data-src', src);
            a.innerHTML = `<img src="${src}" class="w-full h-auto object-cover">`;
            galleryContainer.appendChild(a);
            galleryImages.push(src);
        }

        // Lightbox minimalisir untuk kerapian
        ...
        if (lightbox) {
            ...
            galleryContainer.addEventListener('click', (e) => {
                ...
                lightboxImg.src = link.dataset.src;
        ...
        fetchWishes(); // Load data saat halaman pertama kali dibuka
    </script>
</body>
</html>