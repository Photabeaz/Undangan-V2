...
<body class="font-sans text-textDark antialiased locked">
    ...
    <script>
        ...
        // ==========================================
        //  KONEKSI FRONTEND KE BACKEND (SINGLE FILE PHP & SQLITE)
        // ==========================================
        ...
        // Fungsi Mengirim Ucapan ke file PHP yang sama via JSON POST
        async function submitWish(e) {
            ...
            try {
                ...
                if (result.status === 'success') {
                    ...
                    // Reload data ucapan terbaru secara asynchronous
                    fetchWishes();
                } else {
